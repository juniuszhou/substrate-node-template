...
use node_template_runtime::{opaque::Block, UncheckedExtrinsic, RuntimeCall, Balance, SignedExtra, Runtime};
	...
	TransactionPool: sc_transaction_pool_api::TransactionPool + 'static,
{
    ...
    config.transaction_pool
        .submit_one(&sp_runtime::generic::BlockId::Number(0_u32.into()), TransactionSource::Local, xt.into())
        .await;
